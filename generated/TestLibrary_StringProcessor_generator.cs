...
namespace WFuzzGen
{
    public class TestLibrary_StringProcessor_generator : WFuzz.ICaller
    {
        public object Call(WFuzz.FuzzInput input)
        {
            try
            {
                var type = typeof(TestLibrary.StringProcessor);
                ...
                throw new InvalidOperationException("无法创建类型 TestLibrary.StringProcessor 的实例");
            }
            catch (Exception ex)
            {
